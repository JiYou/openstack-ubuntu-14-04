...
APACHE_NAME=apache2
APACHE_CONF=sites-available/horizon.conf
rm -f /etc/apache2/sites-enabled/*default*
cp -rf $TOPDIR/tools/apache-horizon.template /etc/$APACHE_NAME/$APACHE_CONF
rm -rf /etc/apache2/sites-enabled/horizon.conf
ln -s /etc/$APACHE_NAME/$APACHE_CONF /etc/apache2/sites-enabled/horizon.conf
#cp -rf $TOPDIR/tools/apache-horizon.template /etc/$APACHE_NAME/$APACHE_CONF
#a2ensite horizon
...
cp -rf /tmp/sharedir_openstack/nova.tar.gz /tmp/
umount /tmp/sharedir_openstack/
